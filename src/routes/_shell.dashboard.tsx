...
import { useDashboardActivity } from "@/hooks/dashboard/use-dashboard-activity";
import { useDashboardProjects } from "@/hooks/dashboard/use-dashboard-projects";
import { useDashboardStats } from "@/hooks/dashboard/use-dashboard-stats";
import { useDashboardSuggestions } from "@/hooks/dashboard/use-dashboard-suggestions";
...
function Dashboard() {
  ...
  const { data: suggestions = [] } = useDashboardSuggestions();
  const { data: projects = [] } = useDashboardProjects();
  const { data: agendaItems = [] } = useDashboardActivity();
        ...
        <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-2xl leading-7 text-muted-foreground">
              Welcome back to your Personal AI Operating System. Everything important today is
              organized below. Your projects, studies, content, productivity and AI are connected in
              one place.
            </p>
        ...
        <div className="glass relative overflow-hidden rounded-3xl p-8">
          ...
          <div className="relative">
            ...
            <p className="mt-4 max-w-sm leading-7 text-muted-foreground">
              Unlock unlimited AI conversations, custom agents, finance, intelligent automations,
              cloud memory and every future feature released.
            </p>
