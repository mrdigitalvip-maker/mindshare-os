  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 260 300" aria-hidden="true">
        <defs>
          <linearGradient id="nexora-metal" x1="0" y1="0" x2="1" y2="1">
            <stop stopColor="#e7e3de" />
            <stop offset=".5" stopColor="#666a72" />
            <stop offset="1" stopColor="#17191e" />
          </linearGradient>
          <linearGradient id="nexora-copper" x1="0" y1="0" x2="1" y2="0">
        ...
        <g className="nexora-avatar__body">
          ...
          <rect
            ...
            fill="#d5a66d"
          />
          <path d="M61 112l-10 8v36l10 8M199 112l10 8v36l-10 8" fill="url(#nexora-copper)" />
