...
const styles = StyleSheet.create({
  ...
  eyebrow: { ...typography.label, color: colors.accent, marginBottom: spacing.md },
  heroRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: spacing.md },
  language: { ...typography.h2, color: colors.text },
  level: { ...typography.body, color: colors.textSecondary, marginTop: spacing.xs },
  progressBadge: { alignItems: "flex-end" },
  progressValue: { ...typography.h2, color: colors.accent },
  progressLabel: { ...typography.caption, color: colors.textSecondary },
  progressTrack: { height: 6, backgroundColor: colors.surfaceAlt, borderRadius: radius.full, overflow: "hidden", marginTop: spacing.lg },
  progressFill: { height: "100%", backgroundColor: colors.accent, borderRadius: radius.full },
  emptyTitle: { ...typography.h3, color: colors.text, marginTop: spacing.xs },
  ...
  metricValue: { ...typography.h3, color: colors.text, marginTop: spacing.sm },
  ...
  sectionLabel: { ...typography.label, color: colors.accent },
  ...
  refreshButton: { marginTop: spacing.lg, marginBottom: spacing.lg, alignItems: "center", justifyContent: "center", paddingVertical: spacing.md, borderRadius: radius.lg, backgroundColor: colors.surfaceAlt, borderWidth: 1, borderColor: colors.border },
