...
export const ASSISTANT_QUICK_ACTIONS: readonly AssistantQuickAction[] = [
  { label: "Organizar meu dia", type: "prompt", value: "Organize meu dia com base nas minhas tarefas e prioridades." },
  { label: "Revisar minhas tarefas", type: "prompt", value: "Revise minhas tarefas e sugira a melhor ordem de execução." },
  { label: "Planejar meu projeto", type: "prompt", value: "Ajude a planejar meu projeto com próximos passos objetivos." },
...
export function resolveQuickAction(action: AssistantQuickAction) {
  return action.type === "prompt" ? { draft: action.value, picker: null } : { draft: "", picker: action.type };
}
